<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
  ...
  $realestate_year = array(
    'name'  =>  'advertisement[realestate_year]',
    'id'  => 'realestate_year',
    'value'  => $advertisement->realestate_year,
    'maxlength'  => 4,
    'class'  => 'text',
  );
  $realestate_rooms = array(
    'name'  =>  'advertisement[realestate_rooms]',
    'id'  => 'realestate_rooms',
    'value'  => $advertisement->realestate_rooms,
    'maxlength'  => 4,
    'class'  => 'text',
  );
  $realestate_bathrooms = array(
    'name'  =>  'advertisement[realestate_bathrooms]',
    'id'  => 'realestate_bathrooms',
    'value'  => $advertisement->realestate_bathrooms,
    'maxlength'  => 4,
    'class'  => 'text',
  );
  $realestate_size = array(
    'name'  =>  'advertisement[realestate_size]',
    'id'  => 'realestate_size',
    'value'  => $advertisement->realestate_size,
    'maxlength'  => 10,
    'class'  => 'text',
  );
  $realestate_evaluation = array(
    'name'  =>  'advertisement[realestate_evaluation]',
    'id'  => 'realestate_evaluation',
    'value'  => $advertisement->realestate_evaluation,
    'maxlength'  => 11,
    'class'  => 'text',
  );
  $realestate_possession = array(
    'name'  =>  'advertisement[realestate_possession]',
    'id'  => 'realestate_possession',
    'value'  => $advertisement->realestate_possession,
    'maxlength'  => 20,
    'class'  => 'text',
  );
  $price = array(
  ...
  $realestate_other_info = array(
    'name'  =>  'advertisement[realestate_other_info]',
    'id'  => 'realestate_other_info',
    'value'  => $advertisement->realestate_other_info,
    'style' => 'height:100px',
    'class'  => 'text-area',
  );
...
<!-- page2 -->
    <div class="page">
      ...
      <ul class="form-reg">
        <!-- address -->
        <li class="required">
          <label class="small">Type of Accomodation <span>*</span></label>
          <?php echo form_dropdown('advertisement[realestate_type]', array('Condo'=>'Condo','Bunglow'=>'Bunglow','House'=>'House','Paired'=>'Paired'), ''); ?>
          <?php echo active_errors($advertisement, 'realestate_type' ); ?>
        </li>
        <li class="required">
          <label class="small">Year Built<span>*</span></label>
          <?php echo form_input($realestate_year); ?>
          <?php echo active_errors($advertisement, 'realestate_year' ); ?>
        </li>
        <li class="required">
          <label class="small">Number of Room(s) <span>*</span></label>
          <?php echo form_input($realestate_rooms); ?>
          <?php echo active_errors($advertisement, 'realestate_rooms' ); ?>
        </li>
        <li class="required">
          <label class="small">Number of Bathroom(s) <span>*</span></label>
          <?php echo form_input($realestate_bathrooms); ?>
          <?php echo active_errors($advertisement, 'realestate_bathrooms' ); ?>
        </li>
        <li class="required">
          <label class="small">Measurement of Area <span>*</span></label>
          <?php echo form_dropdown('advertisement[realestate_size_units]', array('M2'=>'M2','Pi2'=>'Pi2'), ''); ?>
          <?php echo active_errors($advertisement, 'realestate_size_units' ); ?>
        </li>
        <li class="required">
          <label class="small">Building Area <span>*</span></label>
          <?php echo form_input($realestate_size); ?>
          <?php echo active_errors($advertisement, 'realestate_size' ); ?>
        </li>
        <li class="required">
          <label class="small">Assessed <span>*</span></label>
          <?php echo form_input($realestate_evaluation); ?>
          <?php echo active_errors($advertisement, 'realestate_evaluation' ); ?>
        </li>
        <li class="required">
          <label class="small">Date of taking Possession (yyyy-mm-dd) <span>*</span></label>
          <?php echo form_input($realestate_possession); ?>
          <?php echo active_errors($advertisement, 'realestate_possession' ); ?>
        </li>
        <li class="required">
          <label class="small">Sales made by <span>*</span></label>
          <?php echo form_dropdown('advertisement[realestate_sellertype]', array('Owner'=>'Owner','Agent'=>'Agent'), ''); ?>
          <?php echo active_errors($advertisement, 'realestate_sellertype' ); ?>
        </li>
        <li class="">
          <label class="small">Other Information </label>
          <?php echo form_input($realestate_other_info); ?>
          <?php echo active_errors($advertisement, 'realestate_other_info' ); ?>
        </li>
