...
<div id="container">
  ...
  <section class="left-section"> 
    <!--Main Box-->
    <div class="side-box">
      <h2 class="article-head border-radius-top">Provide the details of your ad -</h2>
      <div class="main-body">
...
echo form_open_multipart(
  Advertisement::create_url(),'',
  array(
    'advertisement[subcategory_id]' => $advertisement->subcategory_id,     
  )
);
?>
