...
<?php //var_dump($advertisement); ?>
  <section class="left-section"> 
    <!--Main Box-->
    <div class="side-box">
      <h1 class="article-head"><?php echo _h($advertisement->title);?></h1>
        ...
        <div class="details">
          ...
          <div class="padding" id="prd-details" style="display:none">
            <ul class="makelist list-details fl">
              <li><span class="strong">Type of Accomodation:</span><span><?php echo _h($advertisement->realestate_type); ?></span></li>
              <li><span class="strong">Year Built:</span><span><?php echo _h($advertisement->realestate_year); ?></span></li>
              <li><span class="strong">Number of Room(s):</span><span><?php echo _h($advertisement->realestate_rooms); ?></span></li>
              <li><span class="strong">Number of Bathroom(s):</span><span><?php echo _h($advertisement->realestate_bathrooms); ?></span></li>
              <li><span class="strong">Building Area:</span><span><?php echo _h($advertisement->realestate_size." ".$advertisement->realestate_size_units); ?></span></li>
            </ul>
            <ul class="makelist list-details fl">
              <li><span class="strong">Assessed:</span><span><?php echo _h($advertisement->realestate_evaluation); ?></span></li>
              <li><span class="strong">Date of taking Possession:</span><span><?php echo _h($advertisement->realestate_possession); ?></span></li>
              <li><span class="strong">Sales made by:</span><span><?php echo _h($advertisement->realestate_sellertype); ?></span></li>
            </ul>
            <div class="clr">&nbsp;</div>
            <p><strong>Other Information: &nbsp;</strong><?php echo _h($advertisement->realestate_other_info); ?></p>
            <div class="clr">&nbsp;</div>
          </div>
        </div>
